            ...
            <div className="form-row">
              <div className="col">
                <div className="input-group">
                  <input type="text" id="movieSearch" className="form-control" placeholder="Keywords" aria-label="Search for..." />
                  <span className="input-group-btn">
                    <button className="btn btn-success" type="button" onClick={this.handleMovieSearch}>Search</button>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="col">
                ...
                <div className="card error p-1">
                  <p className="errorP">Unable to find a movie</p>
                  <p>Please check your spelling and try agin</p>
                </div>
              </div>
            </div>
          </form>
      ...
      <div className="container">
        ...
        <form>
          <div className="form-row">
            <div className="col">
              <div className="input-group">
                <input type="text" id="movieSearch" className="form-control" placeholder="Keyword" aria-label="Search for..." />
                <span className="input-group-btn">
                  <button className="btn btn-success" type="button" onClick={this.handleMovieSearch}>Search</button>
                </span>
              </div>
